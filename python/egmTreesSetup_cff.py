...
def setTagsProbes(process, options):
    ...
    hltObjects     = 'selectedPatTrigger' #'slimmedPatTrigger' # 'selectedPatTrigger' FOR 2016
    ...
    process.tagEle = cms.EDProducer(eleHLTProducer,
                                        ...
                                        inputs      = cms.InputTag("tagEleMVATight"), #("tagEleCutBasedTight"),
...
def setSequences(process, options):
    ...
    process.tag_sequence = cms.Sequence(
        ...
        process.tagEleMVATight		  + #tagEleCutBasedTight       +
        process.tagEle 
        )
